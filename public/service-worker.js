...
const API_CACHE_NAME = 'folio-api-v1';
...
const STATIC_CACHE_URLS = [
  ...
  'https://fonts.googleapis.com/css2?family=Cal+Sans:wght@400;600&display=swap'
];
...
// Fetch event - serve from cache when offline, update cache for API calls
